...
public class FortranWeaver extends AFortranWeaver {
    ...
    public boolean begin(List<File> sources, File outputDir, DataStore args) {
        ...
        throw new UnsupportedOperationException("Method begin for FortranWeaver is not yet implemented");
    }
    ...
    public JoinPoint select() {
        //return new <AProgram implementation>;
        throw new UnsupportedOperationException("Method select for FortranWeaver is not yet implemented");
    }
    ...
    public boolean close() {
        ...
        throw new UnsupportedOperationException("Method close for FortranWeaver is not yet implemented");
    }
