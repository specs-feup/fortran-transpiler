...
public class FortranJoinpoints {
    ...
    static {
        ...
        JOINPOINT_FACTORY.put(ArrayElement.class, FArrayElement::new);
        ...
        JOINPOINT_FACTORY.put(AttrSpec.class, FAttrSpec::new);
        JOINPOINT_FACTORY.put(OtherAttrSpec.class, FOtherAttrSpec::new);
        ...
        JOINPOINT_FACTORY.put(NameDataRef.class, FNameDataRef::new);
