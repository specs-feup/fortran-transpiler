...
public class Nodes {
    ...
    public Nodes(FortranJsonResult data) {
        ...
        processors.put(ExprInitialization.class, d::exprInitialization);
        processors.put(NullInitialization.class, d::nullInitialization);
        processors.put(DataTargetInitialization.class, d::dataTargetInitialization);
        processors.put(ListInitialization.class, d::listInitialization);
